...
<body class="bg-light min-vh-100 d-flex align-items-center justify-content-center">
    <main class="bg-white border rounded-3 p-4 shadow-sm text-center" style="max-width: 420px;">
        ...
        <a class="btn btn-primary w-100" href="<?php echo e(route('pin.show')); ?>">Accéder à l’application</a>
    </main>
</body>
</html>
<?php /**PATH C:\xa\htdocs\gestion-d-present\presence-system\resources\views\welcome.blade.php ENDPATH**/ ?>