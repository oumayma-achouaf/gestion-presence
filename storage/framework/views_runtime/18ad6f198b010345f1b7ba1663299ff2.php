...
<div class="page-head">
    <div>
        ...
        <div class="page-subtitle">Synthèse quotidienne et historique mensuel.</div>
    </div>
</div>
            ...
            <div class="metric-top">
                ...
                <div class="metric-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                        <path d="<?php echo e($metric['path']); ?>" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </div>
            </div>
...
<div class="card-box mb-4">
    <div class="panel-head">
        <div>
            ...
            <div class="section-sub">Choisir le jour et le mois à afficher</div>
        </div>
    </div>
    ...
    <form method="GET" action="<?php echo e(route('reports.index')); ?>" class="row g-3 align-items-end">
        <div class="col-lg-5">
            ...
            <input class="form-control control-lg" name="day" type="date" value="<?php echo e($day); ?>">
        </div>

        <div class="col-lg-5">
            <label class="form-label">Mois</label>
            <input class="form-control control-lg" name="month" type="month" value="<?php echo e($month); ?>">
        </div>

        <div class="col-lg-2">
            <button class="btn btn-primary w-100 control-lg">Afficher</button>
        </div>
    </form>
</div>
...
<div class="card-box mb-4">
    <div class="panel-head">
        <div>
            ...
            <div class="section-sub"><?php echo e(\Carbon\Carbon::parse($day)->locale('fr')->translatedFormat('d F Y')); ?></div>
        </div>
    </div>
    ...
    <div class="table-responsive">
        <table class="table align-middle">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $dailyAttendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                        $status = $attendance->derivedStatus();
                    ...
                    <tr>
                        <td>
                            <div class="employee-cell">
                                <span class="employee-name"><?php echo e($attendance->user?->employee?->name ?? $attendance->user?->name ?? '-'); ?></span>
                                <span class="employee-meta"><?php echo e($attendance->user?->employee?->position ?? '-'); ?></span>
                            </div>
                        </td>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td colspan="4" class="text-center text-muted py-4">Aucun enregistrement</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
...
<div class="card-box">
    <div class="panel-head">
        <div>
            <h2 class="section-title">Rapport mensuel</h2>
            <div class="section-sub"><?php echo e($month); ?></div>
        </div>
    </div>
    ...
    <div class="d-flex flex-column gap-3">
        <?php $__empty_1 = true; $__currentLoopData = $reportRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employeeName => $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="report-group">
                <div class="report-group-head">
                    <div class="employee-cell">
                        <span class="employee-name"><?php echo e($employeeName); ?></span>
                        <span class="employee-meta"><?php echo e($rows->count()); ?> lignes</span>
                    </div>
                        ...
                        <table class="table table-sm align-middle">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $s = $attendance->derivedStatus();
                                        $sKey = strtolower((string) $s);
                                        $sClass = match(true) {
                                            str_contains($sKey, 'present') => 'status-badge--present',
                                            str_contains($sKey, 'absent') => 'status-badge--absent',
                                            str_contains($sKey, 'repos') => 'status-badge--repos',
                                            str_contains($sKey, 'cong') => 'status-badge--conge',
                                            str_contains($sKey, 'maladie') => 'status-badge--maladie',
                                            str_contains($sKey, 'late') => 'status-badge--late',
                                            default => 'status-badge--default',
                                        };
                                        $sLabel = match(true) {
                                            str_contains($sKey, 'present') => 'Présent',
                                            str_contains($sKey, 'absent') => 'Absent',
                                            str_contains($sKey, 'repos') => 'Repos',
                                            str_contains($sKey, 'cong') => 'Congé',
                                            str_contains($sKey, 'maladie') => 'Maladie',
                                            str_contains($sKey, 'late') => 'En retard',
                                            default => $s,
                                        };
                                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="status-badge <?php echo e($sClass); ?>"><?php echo e($sLabel); ?></span>
                                        </td>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="text-muted">Aucun rapport mensuel disponible.</div>
        <?php endif; ?>
    </div>
</div>
